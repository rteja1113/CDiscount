...
'''
@author: https://github.com/flyyufelix
'''
#import cv2
import numpy as np
import copy

from keras.layers import Input, Dense, Convolution2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Dropout, Flatten, Add, Reshape, Activation, Lambda, GlobalAveragePooling2D 
...
class Scale(Layer):
    ...
    def build(self, input_shape):
        ...
        self.gamma = K.ones(shape=shape, name='{}_gamma'.format(self.name))
        self.beta = K.zeros(shape=shape, name='{}_beta'.format(self.name))
...
def resnet101_model(weights_path=None, input_shape=None):
